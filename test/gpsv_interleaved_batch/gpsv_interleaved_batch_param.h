...
#ifndef TEST_GPSV_INTERLEAVED_BATCH_PARAM_H_
#define TEST_GPSV_INTERLEAVED_BATCH_PARAM_H_
...
struct GpsvInterleavedBatchParam : public SparseTestParamBase {
...
inline std::string PrintCaseInfo(const GpsvInterleavedBatchParam& p) {
...
inline void PrintTo(const GpsvInterleavedBatchParam& p, std::ostream* os) {
    *os << PrintCaseInfo(p);
}
