...
__aicore__ inline SpmmTilingData LoadSpmmTilingData(GM_ADDR tilingGM)
{
    ...
    td.ldb = gmTiling->ldb;
    td.ldc = gmTiling->ldc;
    td.m_tile = gmTiling->m_tile;
    td.n_tile = gmTiling->n_tile;
    td.k_pack = gmTiling->k_pack;
    td.row_bin_num = gmTiling->row_bin_num;
    td.reorder_offset = gmTiling->reorder_offset;
    td.bin_edge_offset = gmTiling->bin_edge_offset;
    td.meta_flag = gmTiling->meta_flag;
    td.blockDim = gmTiling->blockDim;
    td.data_type = gmTiling->data_type;
